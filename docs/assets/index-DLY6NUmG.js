...
export default FormLayout`,V9=()=>n.jsxs(S,{children:[n.jsx(x,{name:"one",label:"Field One",help:"This is what the layout component does",required:!0,children:e=>n.jsxs("div",{className:P1(e),children:[n.jsx(Yr,{}),n.jsx(ca,{}),n.jsx(xi,{})]})}),n.jsx(K,{})]}),q9=`import { Form, Field, Label, Input, Message, Submit, fieldClass } from '@/lib/index.js'
...
export default MessageExample`,dF=()=>{const{message:e,help:t}=rt();return n.jsx("div",{className:"small bold mar-t-2 fgc-40 fgd-60",children:e??t})},cF=()=>n.jsxs(S,{children:[n.jsx(x,{name:"field1",label:"Field One",help:"Enter a value",validMessage:"This is fine!",requiredMessage:"You must enter a value",Message:dF,required:!0}),n.jsx(K,{})]}),uF=`import { Form, Field, Submit, useField } from '@/lib/index.js'
...
export default NameExample`,ZS=()=>n.jsxs(S,{children:[n.jsx(x,{name:"field1"}),n.jsx(K,{})]}),GS=`import { Form, Field, Submit } from '@/lib/index.js'
...
export default ValidateExample`,UC={username:{label:"Username",help:"Enter your username",validate:async(e,t,r,o)=>{e.match(/badger/i)?r({value:`${e} is a great name`}):o({value:"Mr Badger",message:'Your username must contain the word "badger"'})}}},HC=()=>n.jsxs(S,{fields:UC,children:[n.jsx(x,{name:"username"}),n.jsx(K,{})]}),YC=`import { Form, Field, Submit } from '@/lib/index.js'
...
export default OnSubmitExample`,kE=()=>{throw"The server is on fire.  Please try again later."},RE=()=>n.jsxs(S,{onSubmit:kE,children:[n.jsx(x,{name:"username",label:"Pick a username"}),n.jsx(Ve,{}),n.jsx(K,{})]}),NE=`import { Form, Field, Submit, Errors } from '@/lib/index.js'
...
export default OnSubmitThrow`,OE=()=>Promise.reject({error:"Dear Sir/Madam, Fire! Fire! Help me!"}),PE=()=>n.jsxs(S,{onSubmit:OE,children:[n.jsx(x,{name:"message",label:"Message"}),n.jsx(Ve,{}),n.jsx(K,{})]}),AE=`import { Form, Field, Submit, Errors } from '@/lib/index.js'
...
export default FieldsExample`,PT=()=>n.jsxs(S,{children:[n.jsx(x,{name:"name",label:"Your name",required:!0}),n.jsx(x,{name:"email",label:"Your email address",required:!0}),n.jsx(K,{})]}),AT=`import { Form, Field, Submit } from '@/lib/index.js'
...
export default RowsExample`,cO=()=>n.jsxs(n.Fragment,{children:[n.jsx("h2",{className:"font-mono",children:"rows"}),n.jsxs("p",{children:["The ",n.jsx("code",{children:"rows"})," property can be used to set the number of rows."]}),n.jsx(F,{Component:aO,code:dO,caption:"rows",undent:2,expand:!0})]}),uO=Object.freeze(Object.defineProperty({__proto__:null,default:cO},Symbol.toStringTag,{value:"Module"})),mO=()=>n.jsxs(S,{children:[n.jsx("h2",{children:"Login Form"}),n.jsx(x,{required:!0,name:"email",label:"Email Address"}),n.jsx(x,{required:!0,name:"password",type:"password",label:"Password"}),n.jsx(K,{text:"Login"})]}),pO=`import { Form, Field, Submit } from '@/lib/index.js'
...
export default HeadlessBlank`,rP={email:{label:"Email Address",required:!0}},oP=()=>n.jsxs(S,{fields:rP,children:[n.jsx(x,{name:"email",children:e=>n.jsxs(cr,{children:[n.jsxs("h2",{className:"mar-t-none",children:["Custom Layout for ",e.name]}),n.jsx(Yr,{}),n.jsx(Js,{}),n.jsx(xi,{})]})}),n.jsx(K,{text:"Login"})]}),sP=`import {
...
export default HeadlessBuiltins`,iP={email:{label:"Email Address",required:!0}},lP=()=>n.jsxs(S,{fields:iP,children:[n.jsx(x,{name:"email",children:n.jsxs(cr,{children:[n.jsx("h2",{className:"mar-t-none",children:"Custom Layout for Email field"}),n.jsx(Yr,{}),n.jsx(Js,{}),n.jsx(xi,{})]})}),n.jsx(K,{text:"Login"})]}),aP=`import {
  Form, Field, Layout, Label, Text, Message, Submit
} from '@/lib/index.js'
...
export default SubmitThrow`,pP=()=>{const e=()=>{throw new Error("Oh noes! An error occurred")};return n.jsx(n.Fragment,{children:n.jsxs(S,{onSubmit:e,debug:!0,children:[n.jsx(Ve,{}),n.jsx(x,{name:"email",label:"Email Address",required:!0}),n.jsx(x,{name:"password",type:"password",label:"Password",required:!0}),n.jsx(K,{text:"Login"})]})})},fP=`import { Form, Field, Submit, Errors } from '@/lib/index.js'
...
export default SubmitThrow`,hP=()=>{const e=()=>Promise.reject({errors:[{name:"email",message:"Your email address is not valid"},{name:"password",message:"Your password is too easy to guess"}]});return n.jsx(n.Fragment,{children:n.jsxs(S,{onSubmit:e,children:[n.jsx(Ve,{}),n.jsx(x,{name:"email",label:"Email Address",required:!0}),n.jsx(x,{name:"password",type:"password",label:"Password",required:!0}),n.jsx(K,{text:"Login"})]})})},xP=`import { Form, Field, Submit, Errors } from '@/lib/index.js'
...
export default SubmitReject`,gP=()=>{const[e,t]=T.useState(),r=()=>Promise.reject({errors:[{name:"email",message:"Your email address is not valid"},{name:"password",message:"Your password is too easy to guess"}]});return n.jsxs(n.Fragment,{children:[n.jsxs(S,{onSubmit:r,onError:t,children:[n.jsx(x,{name:"email",label:"Email Address",required:!0}),n.jsx(x,{name:"password",type:"password",label:"Password",required:!0}),n.jsx(K,{text:"Login"})]}),e?n.jsxs("div",{className:"info alert mar-t-4 mar-b-none",children:[n.jsx("h4",{children:"Submission Error"}),n.jsx("pre",{children:JSON.stringify(e,null,2)})]}):null]})},bP=`import { Form, Field, Submit } from '@/lib/index.js'
