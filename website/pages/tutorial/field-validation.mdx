import LoginForm    from './_examples/LoginFieldValidation'
import LoginFormSrc from './_examples/LoginFieldValidation.tsx?raw'
...
<Split>
  <div>
    ...
    <a href="https://github.com/jquense/yup">Yup</a> but you should be able
    to use any validation library or even roll your own validation functions
    for special cases.
  ...
  <div>
    ...
    <Suggest>
      ...
      button. If you don't provide a value, or if you provide an invalid value
      then you should see the validation errors.
    </Suggest>
  </div>
</Split>
...
<TSNotes>
If you're using Typescript then you can import the `FieldValue` type
for the value passed to your field `validate` function.
</TSNotes>
